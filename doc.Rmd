...
The application is running on (https://shorturl.at/uBEPY)

ui.R, and Server.R Code in my github repository (https://github.com/rashadahammed/Shiny-Application-and-Reproducible-Pitch)
